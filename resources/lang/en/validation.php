...
return [
    ...
    */
    ...
    'filled' => 'Поле :attribute не должен быть пустым',
    'gt' => [
    ...
    'max' => [
        ...
        'array' => 'Поле :attribute не может быть больше чем :max предметов.',
    ],
    ...
    'min' => [
        ...
        'array' => 'Поле :attribute должен быть не меньше :min предметов.',
    ],
